...
- **[2026-04-05] Context:** 156k-document CoIR benchmark created massive local overhead. → **Decision:** Pivot to "High-Iteration Logic" using a Mini-Golden Benchmark (20 files). → **Rationale:** Prevents "execution traps" and allows rapid logic/UX iteration while `omendb` scaling is in progress.
